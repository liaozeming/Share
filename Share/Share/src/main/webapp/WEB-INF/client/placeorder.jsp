...
<div  class="content_wrap">
    ...
    <div class="invitemark">
        <p><span class="invitemark_l" name="invitecode">邀请码</span><span><input type="text" class="invitemark_r" /></span></p>
    </div>
    <div class="payway">
...
<script>
    ...
    function ShowProject() {
        $.get('${pageContext.request.contextPath}/showOrderProject.action?id='+${id}, function(res){
           ...
           var allmoney=res.supmoney+money;
           var orderMoney='<p class="postorder_num clearfix">支持金额：<span class="postorder_price fr">'+res.supmoney+'</span></p>'+
            ...
            document.getElementById("paymoney").value=res.supmoney+res.sendmoney;



            document.getElementById("WIDsubject").value=res.name;
            document.getElementById("WIDtotal_amount").value=res.supmoney;
